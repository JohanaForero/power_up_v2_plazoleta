...
class AdminControllerTest {
    ...
    @Test
    void test_saveRestaurant_RequestToCreateRestaurantDiscountCompleteAndValid_shouldResponseToCreateRestaurantAndStatusCreated() throws Exception {
        RequestToCreateRestaurantDto restaurantRequestDto = new RequestToCreateRestaurantDto();
        restaurantRequestDto.setName("chachos");
        restaurantRequestDto.setAddress("Calle 12 # 18-22");
        restaurantRequestDto.setPhone("3222222222");
        restaurantRequestDto.setUrlLogo("http://url-imag.com");
        restaurantRequestDto.setNit(23456897L);
    ...
    @WithMockUser(username = USERNAME_ADMIN, password = PASSWORD, roles = {ROLE_ADMIN})
    @Test
    void test_saveRestaurant_withInvalidFormatInFieldPhoneInRequestToCreateRestaurantDto_shouldReturnStatusBadRequest() throws Exception {
        RequestToCreateRestaurantDto restaurantRequestDto = new RequestToCreateRestaurantDto();
        restaurantRequestDto.setName("chachos");
        restaurantRequestDto.setAddress("Calle 12 # 18-22");
    ...
    @WithMockUser(username = USERNAME_ADMIN, password = PASSWORD, roles = {ROLE_ADMIN})
    @Test
    void test_saveRestaurant_withNumericFieldInTheNameOfTheRestaurantInToCreateRestaurantDto_shouldReturnStatusConflict() throws Exception {
        RequestToCreateRestaurantDto restaurantRequestDto = new RequestToCreateRestaurantDto();
    ...
    @WithMockUser(username = USERNAME_ADMIN, password = PASSWORD, roles = {ROLE_ADMIN})
    @Test
    void test_saveRestaurant_withRequestToCreateRestaurantDtoEmpty_shouldReturnStatusConflict() throws Exception {
        RequestToCreateRestaurantDto restaurantRequestDto = new RequestToCreateRestaurantDto();
    ...
    @WithMockUser(username = USERNAME_ADMIN, password = PASSWORD, roles = {ROLE_ADMIN})
    @Test
    void test_saveRestaurant_withObjectRequestToCreateRestaurantDtoAndFieldIdOwnerIsRoleDifferentFromOwner_shouldResponseAccessDeniedStatusForbidden() throws Exception {
        RequestToCreateRestaurantDto restaurantRequestDto = new RequestToCreateRestaurantDto();
    ...
    @WithMockUser(username = USERNAME_ADMIN, password = PASSWORD, roles = {ROLE_ADMIN})
    @Test
    void test_saveRestaurant_withRequestToCreateRestaurantDtoWithValueInTheOwnerIdFieldDoesNotExistUserWithIdOne_shouldResponseUserDoesNotExistReturnStatusNotFound() throws Exception {
        RequestToCreateRestaurantDto restaurantRequestDto = new RequestToCreateRestaurantDto();
        restaurantRequestDto.setName("Nachos de Monterrey");
        restaurantRequestDto.setAddress("Calle 42 # 15-34");
        restaurantRequestDto.setPhone("3893981259");
