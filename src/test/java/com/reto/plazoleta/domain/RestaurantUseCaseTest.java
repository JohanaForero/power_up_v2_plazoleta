...
class RestaurantUseCaseTest {
    ...
    void mustSaveRestaurant() {
        ...
        when(restaurantPersistencePort.saveRestaurant(any())).thenReturn(com.reto.plazoleta.domain.usecase.factory.FactoryRestaurantModelTest.restaurantModel());
        restaurantUseCase.saveRestaurant(com.reto.plazoleta.domain.usecase.factory.FactoryRestaurantModelTest.restaurantModel(), token);
    ...
    void throwEmptyFieldsExceptionWhenSavingRestaurant() {
        RestaurantModel restaurantModelWithEmptyFields = com.reto.plazoleta.domain.usecase.factory.FactoryRestaurantModelTest.restaurantModelEmptyFields();
    ...
    void throwInvalidDataExceptionWhenSavingRestaurantWithPhoneWrong() {
        RestaurantModel restaurantModelWithPhoneWrong = com.reto.plazoleta.domain.usecase.factory.FactoryRestaurantModelTest.restaurantModelWrongPhone();
        Assertions.assertThrows(
    ...
    void throwInvalidDataExceptionWhenSavingRestaurantWhereNameOnlyContainsNumbers() {
        RestaurantModel restaurantModelWhereNameOnlyContainsNumbers =
                com.reto.plazoleta.domain.usecase.factory.FactoryRestaurantModelTest.restaurantModelWhereNameIsJustNumbers();
        Assertions.assertThrows(
                InvalidDataException.class,
